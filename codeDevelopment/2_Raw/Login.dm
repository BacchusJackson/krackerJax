...
mob
	proc
		...
		Idiot()
			switch(input("Are you going to read the rules and follow them Kenton Jackson?(Failure to do so will result in a warning then punishment.)", "", text) in list ("Yes","No"))
				if("Yes")
